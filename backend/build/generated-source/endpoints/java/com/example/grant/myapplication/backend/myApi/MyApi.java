...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.example.grant.myapplication.backend.myApi.model.HttpServletResponse}
   * @return the request
   */
  public PostVideo postVideo(com.example.grant.myapplication.backend.myApi.model.HttpServletResponse content) throws java.io.IOException {
    PostVideo result = new PostVideo(content);
    initialize(result);
    return result;
  }
  ...
  public class PostVideo extends MyApiRequest<com.example.grant.myapplication.backend.myApi.model.MyBean> {
    ...
    private static final String REST_PATH = "postVideo";
     ...
     * @since 1.13
     */
    protected PostVideo(com.example.grant.myapplication.backend.myApi.model.HttpServletResponse content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.grant.myapplication.backend.myApi.model.MyBean.class);
    }
