...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetUserData#execute()} method to invoke the remote operation.
   *
   * @param userEmail
   * @return the request
   */
  public GetUserData getUserData(java.lang.String userEmail) throws java.io.IOException {
    GetUserData result = new GetUserData(userEmail);
    initialize(result);
    return result;
  }

  public class GetUserData extends MyApiRequest<com.example.grant.myapplication.backend.myApi.model.UserDataHolder> {

    private static final String REST_PATH = "signin/{userEmail}";

    /**
     * Create a request for the method "getUserData".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link GetUserData#execute()} method to invoke the remote operation. <p>
     * {@link
     ...
     * @since 1.13
     */
    protected GetUserData(java.lang.String userEmail) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.grant.myapplication.backend.myApi.model.UserDataHolder.class);
    ...
    public GetUserData setUserEmail(java.lang.String userEmail) {
